        ...
        <div class="content">
            ...
            <div class="row">
                    ...
                    <div id="carouselExampleCaption" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <img src="assets/img/Slider1.jpg" style="width:100%;height:200px;" alt="..." class="d-block img-fluid mx-auto">
                            ...
                            <div class="carousel-item">
                                <img src="assets/img/Slider2.jpg" style="width:100%;height:200px;" alt="..." class="d-block img-fluid mx-auto">
                                <div class="carousel-caption d-none d-md-block">
                                    <h4></h4>
                                    <p></p>
                                </div>
                            ...
                            <div class="carousel-item">
                                <img src="assets/img/Slider3.jpg" style="width:100%;height:200px;" alt="..." class="d-block img-fluid mx-auto">
                                <div class="carousel-caption d-none d-md-block">
                                    <h4></h4>
                                    <p></p>
                                </div>
                ...
                <div class="page-title-box">
                    <div class="row">
                        <div class="col-xl-12">
                            <h5 class="text-left">Rungkut Active Trainer </h5>
                            <div class="row">
                                <div class="col-sm-6 col-xl-4">
                                    <div class="card bg-light">
                                        <img class="card-img-top mt-3 mx-auto d-block img-fluid" style="width: 100px; height: 125px" src="<?php echo base_url('assets/img/active/1.png'); ?>" alt="thumbnail">
                                        <div class="card-body">
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="card bg-light">
                                        <img class="card-img-top mt-3 mx-auto d-block img-fluid" style="width: 100px; height: 125px" src="<?php echo base_url('assets/img/active/2.png'); ?>" alt="thumbnail">
                                        <div class="card-body">
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="card bg-light">
                                        <img class="card-img-top mt-3 mx-auto d-block img-fluid" style="width: 100px; height: 125px" src="<?php echo base_url('assets/img/active/3.png'); ?>" alt="thumbnail">
                                        <div class="card-body">
                            ...
                            <h5 class="text-left mb-3">Daftar Training </h5>
                            ...
                            <div class="row">                                        
                                <div class="col-xl-12 text-center">
                                    ...
                                    <a href="training"><h6>More Training</h6></a>
                                    <hr style="height:1px;border-width:0;color:gray;background-color:gray;width:60%;text-align:left;margin-left:20%">                                                
                                </div>
                            </div>       
                        </div>
