...
<div class='alert alert-danger alert-dismissible'>
         ...
         <b></b> " . $this->session->flashdata('alert') . "
                ...
                <form class="form-horizontal m-t-30" method="POST" action="login/validate">
                    ...
                    <div class="form-group row m-t-30 m-b-0">
                        ...
                        <div class="col-sm-12 text-right">
                            <a href="#" class="text-muted" data-toggle="modal" data-target="#loginwithqr"><i class="fas fa-user m-r-5"></i> Login with QR CODE</a>
                        </div>
    ...
    <!-- END wrapper -->
    <!-- Modal -->
    <div class="modal fade" id="loginwithqr" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Login With QRCODE</h5>
