                            ...
                            <div class="row">
                                <div class="col-md-12">                                
                                    <div class="form-group row">
                                        <h4 class="mt-0 header-title">Master SIO Type</h4>
                                    </div>                            
                                </div>
                            </div>
                            <div class="row mb-3">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="myLargeModalLabel">Tambah SIO Type</h5>
                ...
                <div class="row">
                    <div class="col-12">     
                        <div class="form-group col-md-12">
                            <div class="col-sm-12">
                                <label for="">SIO Type</label>
                                <input class="form-control" placeholder="Input SIO Type" type="text" name="department_name" value="" id="">
                            </div>
                        </div>                    
                    </div> <!-- end col -->                            
                </div> <!-- end row -->                                              
...
<div class="modal fade" id="modalEdit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="myLargeModalLabel">Edit SIO Type</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="modalImport" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0">Import Data SIO Type</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
