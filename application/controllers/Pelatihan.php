...
class Pelatihan extends CI_Controller
{
    ...
    {
        $data = array(
            'datacategory' => $this->MData->selectdata('users_materi_category', array('nip' => $this->session->userdata('nip'))),
        );

        $this->template->load('layoutkaryawan', 'pelatihan/pelatihan', $data);
    }
}
